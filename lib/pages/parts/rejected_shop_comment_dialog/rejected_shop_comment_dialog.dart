...
import 'package:skar_super_admin/pages/parts/rejected_shop_comment_dialog/rejected_shop_comment_dialog_content.dart';
            ...
            onPressed: () async {
              if (formKey.currentState?.validate() == true) {
                ShopParams params = ShopParams(
                  context: context,
                  shopCreatedStatus:
                      ShopCreatedStatus(id: widget.shopID, createdStatus: 1),
                );
