...
class CategoryApiService {
  ...
  Future<ResultCategory> fetchCategoriesWithChild(
    ...
    String url = "with-child";
    if (isDeleted) {
      url = "deleted";
    }

    Uri uri = Uri.parse('$apiUrl/back/categories/$url').replace(
      queryParameters: {
        'limit': '100',
        'page': '$page',
        'search': search,
...
//  restore category -------------------------------------------------------
  Future<ResultCategory> restoreCategory({
    required String accessToken,
    required String categoryID,
  }) async {
    Uri uri = Uri.parse('$apiUrl/back/categories/$categoryID/restore');
...
//  delete permanently category -------------------------------------------------------
  Future<ResultCategory> deletePermanentlyCategory({
    required String accessToken,
    required String categoryID,
  }) async {
    Uri uri = Uri.parse('$apiUrl/back/categories/$categoryID/delete');
